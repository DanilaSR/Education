...
//  -------------------------------------------------------------------------------------------
    ...
    friend auto operator<=>(Rational const & lhs, Rational const & rhs)
    {
        ...
        if (lhs.m_num * rhs.m_den < rhs.m_num * lhs.m_den) { return std::partial_ordering::less;    }

        if (lhs.m_num * rhs.m_den > rhs.m_num * lhs.m_den) { return std::partial_ordering::greater; }
